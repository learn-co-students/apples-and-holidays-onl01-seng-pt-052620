...
def all_winter_holiday_supplies(holiday_hash)
  new_array = holiday_hash[:winter].map do |holiday, supply|
    supply
  end
  new_array.flatten# return an array of all of the supplies that are used in the winter season
end
